    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-5 left-5 md:top-10 md:left-10 text-3xl md:text-6xl opacity-20 animate-bounce">🌟</div>
          <div className="absolute top-10 right-5 md:top-20 md:right-20 text-2xl md:text-5xl opacity-20 animate-pulse">⚡</div>
          <div className="absolute bottom-10 left-5 md:bottom-20 md:left-20 text-2xl md:text-4xl opacity-20 animate-bounce">🚀</div>
          <div className="absolute bottom-5 right-5 md:bottom-10 md:right-10 text-3xl md:text-5xl opacity-20 animate-pulse">💫</div>
        </div>
        ...
        <div className="relative z-10 w-full">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="text-center mb-6 md:mb-8">
              <img 
                src="/images/coding-ai.jpg" 
                alt="Kids Learning Coding and Programming - Colorful Code on Computer Screen"
                className="mx-auto rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl max-w-full h-auto hover:scale-105 transition-all duration-500 border-2 md:border-4 border-white/20"
                style={{ maxHeight: '250px', objectFit: 'cover', width: '100%', maxWidth: '500px' }}
              />
            </div>
            ...
            <div className="text-center">
              ...
              <div className="relative mb-6 md:mb-8">
                <div className="text-6xl md:text-8xl lg:text-9xl drop-shadow-2xl animate-bounce">
                  {characters[currentCharacter].emoji}
                </div>
              </div>

            <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6 text-white drop-shadow-lg px-2">
              Coding & AI Adventures for Kids! 🌟
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 text-white/90 max-w-4xl mx-auto drop-shadow-md px-4">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6 md:mb-8 px-4">
              {characters.map((char, index) => (
                <button
                  ...
                  className={`text-2xl md:text-4xl p-2 md:p-3 rounded-full transition-all duration-300 ${
            ...
            {/* Character Info */}
            <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-4 md:p-6 mb-6 md:mb-8 max-w-2xl mx-auto border border-white/20">
              <h3 className="text-xl md:text-2xl font-bold mb-2" style={{ color: characters[currentCharacter].color }}>
                {characters[currentCharacter].name}
              </h3>
              <p className="text-base md:text-lg mb-2 opacity-90">{characters[currentCharacter].role}</p>
              <p className="text-sm md:text-base mb-3 opacity-80">{characters[currentCharacter].description}</p>
              <p className="text-base md:text-lg italic font-medium text-yellow-200">
                "{characters[currentCharacter].quote}"
              </p>
            </div>

            {/* Main CTAs */}
            <div className="flex flex-col gap-4 justify-center items-center mb-6 px-4">
              <button
                onClick={onStartTrial}
                className="bg-gradient-to-r from-pink-500 to-rose-500 text-white text-lg md:text-xl font-bold px-6 md:px-8 py-3 md:py-4 rounded-full shadow-2xl hover:scale-105 transition-all duration-300 hover:shadow-pink-500/25 flex items-center gap-2 w-full max-w-xs text-center justify-center"
              >
                🎮 Start FREE Adventure!
              </button>
              <a
                href={`https://wa.me/${siteConfig.whatsapp}?text=I%20want%20to%20join%20the%20Coding%20AI%20Adventure!`}
                className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-lg md:text-xl font-bold px-6 md:px-8 py-3 md:py-4 rounded-full shadow-2xl hover:scale-105 transition-all duration-300 hover:shadow-green-500/25 flex items-center gap-2 w-full max-w-xs text-center justify-center"
              >
                💬 Chat with Us!
              </a>
            </div>
            ...
            {/* Quick Stats */}
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm opacity-90 px-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xl md:text-2xl">👥</span>
                <span className="text-sm md:text-base">10,000+ Happy Kids</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xl md:text-2xl">🎯</span>
                <span className="text-sm md:text-base">Ages 6-16</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xl md:text-2xl">⏱️</span>
                <span className="text-sm md:text-base">12 Fun-Filled Weeks</span>
              </div>
            </div>
            </div>
          </div>
