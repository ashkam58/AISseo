    ...
    <>
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .hero-stats { grid-template-columns: 1fr !important; gap: 0.75rem !important; }
          .courses-grid { grid-template-columns: 1fr !important; gap: 1.25rem !important; }
          .course-card { border-radius: 12px !important; }
          .cta-buttons { flex-direction: column !important; }
          .cta-buttons a, .course-cta, .contact-cta { width: 100% !important; }
        }
